...
class Hbp::SystemCommand
  def self.run(executable, options={})
    ...
    Hbp::SystemCommand::Result.new(command, processed_stdout, processed_stderr, processed_status.exitstatus)
  end
...
class Hbp::SystemCommand::Result
