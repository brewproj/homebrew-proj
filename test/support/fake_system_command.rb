class Hbp::FakeSystemCommand
  ...
  def self.run(command, options={})
    command = Hbp::SystemCommand._process_options(command, options)
    ...
    Hbp::SystemCommand::Result.new(command, responses[command], '', 0)
  end
...
module FakeSystemCommandHooks
  def after_teardown
    super
    Hbp::FakeSystemCommand.verify_expectations!
  ensure
    Hbp::FakeSystemCommand.clear
  end
end
